...
public class Education_completion {
 ...
 private static final String DATABASE = "jdbc:sqlite:database/database.db";
   ...
   private static final String CSV_FILE1 = "database/lga_highest_year_of_school_completed_by_indigenous_status_by_sex_2021.csv";
   ...
   static void process2021(){
      ...
      try {
         // Open A CSV File to process, one line at a time
         // CHANGE THIS to process a different file
         Scanner lineScanner = new Scanner(new File(CSV_FILE1));      // scanner đọc từ tệp CSV_FILE 
